...
export const columnNameToJapaneseSalesTarget = (
  ...
  switch (columnName) {
    ...
    case "entity_name":
      ...
      return "";
      break;
    case "fiscal_year_sales_target":
      return `${fiscalYear}年度`;
      break;
    case "first_half_sales_target":
      return "上期";
      break;
    case "second_half_sales_target":
      return "下期";
      break;
    case "first_quarter_sales_target":
      return "第1四半期";
      break;
    case "second_quarter_sales_target":
      return "第2四半期";
      break;
    case "third_quarter_sales_target":
      return "第3四半期";
      break;
    case "fourth_quarter_sales_target":
      return "第4四半期";
      break;
    case "January_sales_target":
      return "1月度";
      break;
    case "February_sales_target":
      return "2月度";
      break;
    case "March_sales_target":
      return "3月度";
      break;
    case "April_sales_target":
      return "4月度";
      break;
    case "May_sales_target":
      return "5月度";
      break;
    case "June_sales_target":
      return "6月度";
      break;
    case "July_sales_target":
      return "7月度";
      break;
    case "August_sales_target":
      return "8月度";
      break;
    case "September_sales_target":
      return "9月度";
      break;
    case "October_sales_target":
      return "10月度";
      break;
    case "November_sales_target":
      return "11月度";
      break;
    case "December_sales_target":
      return "12月度";
      break;
    // 前年売上、前年比、前年伸び実績
    // 前年売上
