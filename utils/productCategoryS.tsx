...
// ------------------------------------------------------------------------------------------
// 🌠全ての小分類のnameのSetオブジェクト
export const productCategoriesSmallNameOnlySet: Set<ProductCategoriesSmall> = new Set([
  // 電子部品・モジュール
  ...categoryS_electronicComponents_NameOnly,
  ...categoryS_connectors_NameOnly,
  ...categoryS_terminalBlocks_NameOnly,
  ...categoryS_led_NameOnly,
  ...categoryS_fpdTouchPanel_NameOnly,
  ...categoryS_smallMotors_NameOnly,
  ...categoryS_powerSources_NameOnly,
  ...categoryS_batteries_NameOnly,
  ...CategoryS_semiconductorsIc_NameOnly,
  ...categoryS_rfid_ic_tag_NameOnly,
  ...categoryS_optical_components_NameOnly,
  ...categoryS_cables_NameOnly,
  ...categoryS_contracted_services_NameOnly,
  // 機械部品
  ...categoryS_mechanical_elements_NameOnly,
  ...categoryS_bearings_NameOnly,
  ...categoryS_screws_NameOnly,
  ...categoryS_motors_NameOnly,
  ...categoryS_pumps_NameOnly,
  ...categoryS_piping_components_NameOnly,
  ...categoryS_water_oil_hydraulic_pneumatic_equipment_NameOnly,
  ...categoryS_vacuum_equipment_NameOnly,
  ...categoryS_molds_NameOnly,
  ...categoryS_jigs_NameOnly,
  ...categoryS_automotive_parts_NameOnly,
  // 製造・加工機械
  ...categoryS_machine_tools_NameOnly,
  ...categoryS_processing_machines_NameOnly,
  ...categoryS_semiconductor_manufacturing_equipment_NameOnly,
  ...categoryS_mounting_machines_NameOnly,
  ...categoryS_industrial_robots_NameOnly,
  ...categoryS_assembly_machines_NameOnly,
  ...categoryS_painting_machines_NameOnly,
  ...categoryS_food_machines_NameOnly,
  ...categoryS_packaging_machines_NameOnly,
  ...categoryS_conveying_machines_NameOnly,
  ...categoryS_marking_NameOnly,
  ...categoryS_contracted_services_processing_machinery_NameOnly,
  // 科学・理化学機器
  ...categoryS_chemical_equipment_NameOnly,
  ...categoryS_cleaning_machines_NameOnly,
  ...categoryS_powder_equipment_NameOnly,
  ...categoryS_heating_equipment_furnaces_NameOnly,
  ...categoryS_surface_treatment_equipment_NameOnly,
  ...categoryS_laboratory_equipment_supplies_NameOnly,
  // 素材・材料
  ...categoryS_metal_materials_NameOnly,
  ...categoryS_polymer_materials_NameOnly,
  ...categoryS_glass_NameOnly,
  ...categoryS_ceramics_NameOnly,
  ...categoryS_wood_NameOnly,
  ...categoryS_paper_pulps_NameOnly,
  ...categoryS_organic_natural_materials_NameOnly,
  ...categoryS_chemicals_NameOnly,
  // 画像処理
  ...categoryS_distance_measuring_machine_NameOnly,
  ...categoryS_weight_measuring_machine_NameOnly,
  ...categoryS_electronic_measuring_machine_NameOnly,
  ...categoryS_temperature_humidity_machine_NameOnly,
  ...categoryS_electrical_machine_NameOnly,
  ...categoryS_coordinate_measuring_machine_NameOnly,
  ...categoryS_other_measuring_machine_NameOnly,
  ...categoryS_testing_machine_NameOnly,
  ...categoryS_inspection_machine_NameOnly,
  ...categoryS_microscopes_NameOnly,
  ...categoryS_recorders_loggers_NameOnly,
  ...categoryS_analytical_machine_NameOnly,
  ...categoryS_environmental_analysis_machine_NameOnly,
  ...categoryS_contracted_services_analysis_NameOnly,
  // 画像処理
  ...categoryS_cameras_NameOnly,
  ...categoryS_lenses_NameOnly,
  ...categoryS_light_sources_lighting_NameOnly,
  ...categoryS_image_processing_NameOnly,
  ...categoryS_security_surveillance_systems_NameOnly,
  ...categoryS_barcode_readers_NameOnly,
  // 制御・電機機器
  ...categoryS_process_control_equipment_NameOnly,
  ...categoryS_fa_equipment_NameOnly,
  ...categoryS_safety_equipment_NameOnly,
  ...categoryS_environmental_equipment_NameOnly,
  ...categoryS_filters_NameOnly,
  ...categoryS_clean_rooms_NameOnly,
  ...categoryS_lighting_NameOnly,
  ...categoryS_air_conditioning_equipment_NameOnly,
  ...categoryS_water_treatment_equipment_NameOnly,
  ...categoryS_static_electricity_measures_NameOnly,
  ...categoryS_energy_equipment_NameOnly,
  // 工具・消耗品・備品
  ...categoryS_cutting_tools_NameOnly,
  ...categoryS_abrasives_NameOnly,
  ...categoryS_hand_tools_NameOnly,
  ...categoryS_power_pneumatic_tools_NameOnly,
  ...categoryS_consumables_NameOnly,
  ...categoryS_cleaning_tools_NameOnly,
  ...categoryS_safety_hygiene_supplies_NameOnly,
  ...categoryS_packaging_materials_NameOnly,
  ...categoryS_supplies_NameOnly,
  ...categoryS_storage_facilities_NameOnly,
  // 設計・生産支援
  ...categoryS_cad_NameOnly,
  ...categoryS_cam_NameOnly,
  ...categoryS_cae_NameOnly,
  ...categoryS_prototype_NameOnly,
  ...categoryS_contracted_services_design_NameOnly,
  // IT・ネットワーク
  ...categoryS_industrial_computers_NameOnly,
  ...categoryS_embedded_systems_NameOnly,
  ...categoryS_core_systems_NameOnly,
  ...categoryS_production_management_NameOnly,
  ...categoryS_information_systems_NameOnly,
  ...categoryS_network_NameOnly,
  ...categoryS_operating_systems_NameOnly,
  ...categoryS_servers_NameOnly,
  ...categoryS_security_NameOnly,
  // オフィス
  ...categoryS_office_automation_equipment_NameOnly,
  ...categoryS_consumables_IT_NameOnly,
  ...categoryS_supplies_IT_NameOnly,
  // 業務支援サービス
  ...categoryS_consultants_NameOnly,
  ...categoryS_rental_lease_NameOnly,
  ...categoryS_human_resources_services_NameOnly,
  ...categoryS_services_NameOnly,
  // セミナー・スキルアップ
  ...categoryS_for_engineer_NameOnly,
  ...categoryS_for_management_NameOnly,
  // その他
  ...categoryS_others_NameOnly,
]);

// 🌠小分類の全てのマッピングオブジェクト
export const mappingProductCategoriesSmall: { [K in ProductCategoriesSmall | string]: { [key: string]: string } } = {
  // 電子部品・モジュール
  ...mappingCategoryS_ElectronicComponents,
  ...mappingCategoryS_Connectors,
  ...mappingCategoryS_TerminalBlocks,
  ...mappingCategoryS_Led,
  ...mappingCategoryS_FpdTouchPanel,
  ...mappingCategoryS_SmallMotors,
  ...mappingCategoryS_PowerSources,
  ...mappingCategoryS_Batteries,
  ...mappingCategoryS_SemiconductorsIc,
  ...mappingCategoryS_rfid_ic_tag,
  ...mappingCategoryS_optical_components,
  ...mappingCategoryS_cables,
  ...mappingCategoryS_contracted_services,
  // 機械部品
  ...mappingCategoryS_mechanical_elements,
  ...mappingCategoryS_bearings,
  ...mappingCategoryS_screws,
  ...mappingCategoryS_motors,
  ...mappingCategoryS_pumps,
  ...mappingCategoryS_piping_components,
  ...mappingCategoryS_water_oil_hydraulic_pneumatic_equipment,
  ...mappingCategoryS_vacuum_equipment,
  ...mappingCategoryS_molds,
  ...mappingCategoryS_jigs,
  ...mappingCategoryS_automotive_parts,
  // 製造・加工機械
  ...mappingCategoryS_machine_tools,
  ...mappingCategoryS_processing_machines,
  ...mappingCategoryS_semiconductor_manufacturing_equipment,
  ...mappingCategoryS_mounting_machines,
  ...mappingCategoryS_industrial_robots,
  ...mappingCategoryS_assembly_machines,
  ...mappingCategoryS_painting_machines,
  ...mappingCategoryS_food_machines,
  ...mappingCategoryS_packaging_machines,
  ...mappingCategoryS_conveying_machines,
  ...mappingCategoryS_marking,
  ...mappingCategoryS_contracted_services_processing_machinery,
  // 科学・理化学機器
  ...mappingCategoryS_chemical_equipment,
  ...mappingCategoryS_cleaning_machines,
  ...mappingCategoryS_powder_equipment,
  ...mappingCategoryS_heating_equipment_furnaces,
  ...mappingCategoryS_surface_treatment_equipment,
  ...mappingCategoryS_laboratory_equipment_supplies,
  // 素材・材料
  ...mappingCategoryS_metal_materials,
  ...mappingCategoryS_polymer_materials,
  ...mappingCategoryS_glass,
  ...mappingCategoryS_ceramics,
  ...mappingCategoryS_wood,
  ...mappingCategoryS_paper_pulps,
  ...mappingCategoryS_organic_natural_materials,
  ...mappingCategoryS_chemicals,
  // 画像処理
  ...mappingCategoryS_distance_measuring_machine,
  ...mappingCategoryS_weight_measuring_machine,
  ...mappingCategoryS_electronic_measuring_machine,
  ...mappingCategoryS_temperature_humidity_machine,
  ...mappingCategoryS_electrical_machine,
  ...mappingCategoryS_coordinate_measuring_machine,
  ...mappingCategoryS_other_measuring_machine,
  ...mappingCategoryS_testing_machine,
  ...mappingCategoryS_inspection_machine,
  ...mappingCategoryS_microscopes,
  ...mappingCategoryS_recorders_loggers,
  ...mappingCategoryS_analytical_machine,
  ...mappingCategoryS_environmental_analysis_machine,
  ...mappingCategoryS_contracted_services_analysis,
  // 画像処理
  ...mappingCategoryS_cameras,
  ...mappingCategoryS_lenses,
  ...mappingCategoryS_light_sources_lighting,
  ...mappingCategoryS_image_processing,
  ...mappingCategoryS_security_surveillance_systems,
  ...mappingCategoryS_barcode_readers,
  // 制御・電機機器
  ...mappingCategoryS_process_control_equipment,
  ...mappingCategoryS_fa_equipment,
  ...mappingCategoryS_safety_equipment,
  ...mappingCategoryS_environmental_equipment,
  ...mappingCategoryS_filters,
  ...mappingCategoryS_clean_rooms,
  ...mappingCategoryS_lighting,
  ...mappingCategoryS_air_conditioning_equipment,
  ...mappingCategoryS_water_treatment_equipment,
  ...mappingCategoryS_static_electricity_measures,
  ...mappingCategoryS_energy_equipment,
  // 工具・消耗品・備品
  ...mappingCategoryS_cutting_tools,
  ...mappingCategoryS_abrasives,
  ...mappingCategoryS_hand_tools,
  ...mappingCategoryS_power_pneumatic_tools,
  ...mappingCategoryS_consumables,
  ...mappingCategoryS_cleaning_tools,
  ...mappingCategoryS_safety_hygiene_supplies,
  ...mappingCategoryS_packaging_materials,
  ...mappingCategoryS_supplies,
  ...mappingCategoryS_storage_facilities,
  // 設計・生産支援
  ...mappingCategoryS_cad,
  ...mappingCategoryS_cam,
  ...mappingCategoryS_cae,
  ...mappingCategoryS_prototype,
  ...mappingCategoryS_contracted_services_design,
  // IT・ネットワーク
  ...mappingCategoryS_industrial_computers,
  ...mappingCategoryS_embedded_systems,
  ...mappingCategoryS_core_systems,
  ...mappingCategoryS_production_management,
  ...mappingCategoryS_information_systems,
  ...mappingCategoryS_network,
  ...mappingCategoryS_operating_systems,
  ...mappingCategoryS_servers,
  ...mappingCategoryS_security,
  // オフィス
  ...mappingCategoryS_office_automation_equipment,
  ...mappingCategoryS_consumables_IT,
  ...mappingCategoryS_supplies_IT,
  // 業務支援サービス
  ...mappingCategoryS_consultants,
  ...mappingCategoryS_rental_lease,
  ...mappingCategoryS_human_resources_services,
  ...mappingCategoryS_services,
  // セミナー・スキルアップ
  ...mappingCategoryS_for_engineer,
  ...mappingCategoryS_for_management,
  // その他
  ...mappingCategoryS_others,
};
