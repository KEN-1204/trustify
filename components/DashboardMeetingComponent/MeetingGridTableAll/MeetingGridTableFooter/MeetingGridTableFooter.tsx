...
import styles from "./MeetingGridTableFooter.module.css";
...
const MeetingGridTableFooterMemo: FC<Props> = ({ getItemCount, getTotalCount }) => {
...
export const MeetingGridTableFooter = memo(MeetingGridTableFooterMemo);
