...
// const MeetingMainContainerMemo: FC = () => {
...
//   const [inputMeetingDate, setInputMeetingDate] = useState<Date | null>(null);
...
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams["activities.created_by_company_id"])
//       );
//       setInputMeetingCreatedByUserId(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams["activities.created_by_user_id"])
//       );
//       setInputMeetingCreatedByDepartmentOfUser(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams["activities.created_by_department_of_user"])
//       );
//       setInputMeetingCreatedByUnitOfUser(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams["activities.created_by_unit_of_user"])
//       );
//       setInputSummary(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.summary));
...
//       setInputScheduledFollowUpDate(
//         newSearchMeeting_Contact_CompanyParams.scheduled_follow_up_date
//           ? new Date(newSearchMeeting_Contact_CompanyParams.scheduled_follow_up_date)
//           : null
//       );
//       setInputFollowUpFlag(newSearchMeeting_Contact_CompanyParams.follow_up_flag);
//       setInputDocumentUrl(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.document_url));
//       setInputMeetingType(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.Meeting_type));
//       setInputClaimFlag(newSearchMeeting_Contact_CompanyParams.claim_flag);
//       setInputProductIntroduction1(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.product_introduction1)
//       );
//       setInputProductIntroduction2(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.product_introduction2)
//       );
//       setInputProductIntroduction3(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.product_introduction3)
//       );
//       setInputProductIntroduction4(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.product_introduction4)
//       );
//       setInputProductIntroduction5(
//         beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.product_introduction5)
//       );
//       setInputBusinessOffice(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.business_office));
//       setInputMemberName(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.member_name));
//       setInputPriority(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.priority));
//       // setInputMeetingDate(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.Meeting_date));
//       setInputMeetingDate(
//         newSearchMeeting_Contact_CompanyParams.Meeting_date
//           ? new Date(newSearchMeeting_Contact_CompanyParams.Meeting_date)
//           : null
//       );
//       setInputDepartment(beforeAdjustFieldValue(newSearchMeeting_Contact_CompanyParams.department));
//     } else {
//       setInputCompanyName("");
//       setInputContactName("");
...
//     // let _meeting_date = adjustFieldValue(inputMeetingDate);
//     let _meeting_date = inputMeetingDate ? inputMeetingDate.toISOString() : null;
...
//       // activitiesテーブル
//       "activities.created_by_company_id": _meeting_created_by_company_id,
//       "activities.created_by_user_id": _meeting_created_by_user_id,
//       "activities.created_by_department_of_user": _meeting_created_by_user_id,
//       "activities.created_by_unit_of_user": _meeting_created_by_user_id,
//       summary: _summary,
...
//                       {!searchMode && (
//                         <span className={`${styles.value}`}>
//                           {selectedRowDataMeeting?.claim ? selectedRowDataMeeting?.claim : ""}
//                         </span>
//                       )}
...
//                       {!searchMode && (
//                         <span className={`${styles.value}`}>
//                           {selectedRowDataMeeting?.meeting_date
//                             ? format(new Date(selectedRowDataMeeting.meeting_date), "yyyy-MM-dd")
//                             : ""}
//                         </span>
//                       )}
//                       {searchMode && <input type="text" className={`${styles.input_box}`} />}
...
//                             checked={!!selectedRowDataMeeting?.claim_flag}
//                             onChange={() => {
//                               setLoadingGlobalState(false);
//                               setIsOpenUpdateMeetingModal(true);
//                             }}
...
//                           // onMouseLeave={handleCloseTooltip}
//                         >
//                           {selectedRowDataMeeting?.priority ? selectedRowDataMeeting?.priority : ""}
//                         </span>
//                       )}
//                       {searchMode && <input type="text" className={`${styles.input_box}`} />}
//                     </div>
...
// export const MeetingMainContainer = memo(MeetingMainContainerMemo);
