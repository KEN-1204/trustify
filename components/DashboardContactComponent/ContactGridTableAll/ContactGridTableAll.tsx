...
const ContactGridTableAllMemo: FC<Props> = ({ title }) => {
  ...
  // console.log(
  //   "🔥ContactGridTableAllMemoコンポーネント 入れ替え後のカラム editedColumnHeaderItemList ",
  ...
  const columnIndexToHeaderObjMap = useMemo(() => {
    return new Map(contactColumnHeaderItemList.map((obj) => [obj.columnIndex, obj]));
              ...
              <>
                ...
                >
                  {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                    ...
                    const isAlert =
                      (rowData as Contact_row_data)?.call_careful_flag || !!(rowData as Contact_row_data)?.claim;
...
export const ContactGridTableAll = memo(ContactGridTableAllMemo);
