...
const ContactUnderRightGridTableFooterMemo: FC<Props> = ({ getItemCount }) => {
...
export const ContactUnderRightGridTableFooter = memo(ContactUnderRightGridTableFooterMemo);
