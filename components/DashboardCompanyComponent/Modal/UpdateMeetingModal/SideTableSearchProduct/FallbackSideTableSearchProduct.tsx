...
export const FallbackSideTableSearchProduct = ({ isOpenSearchProductSideTable }: Props) => {
    ...
    <>
      ...
      <div
        className={`${styles.side_table} ${styles.change_member} z-[1200] pt-[30px] ${
          isOpenSearchProductSideTable ? `${styles.active}` : ``
        }`}
      >
        {/* タイトルエリア */}
            ...
            <ul className={`mt-[20px] flex flex-col text-[13px] text-[var(--color-text-title)]`}>
              {searchProductInputFields.map((item, index) => (
                ...
                >
                  ...
                  <input type="text" placeholder="" className={`${styles.input_box}`} value={""} readOnly />
                </li>
              ))}
