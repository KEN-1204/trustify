...
const ProgressCircleIncrementMemo = ({
  circleId,
  textId,
  progress = 75,
  startProgress = 0,
  ...
  useEffect(() => {
    ...
    function animate(timestamp: number) {
      ...
      const easedProgress = fromProgress + easeFunction(t) * (progress - fromProgress);
...
export const ProgressCircleIncrement = memo(ProgressCircleIncrementMemo);
