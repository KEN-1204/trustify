...
import styles from "./PropertyGridTableFooter.module.css";
...
const PropertyGridTableFooterMemo: FC<Props> = ({ getItemCount, getTotalCount }) => {
...
export const PropertyGridTableFooter = memo(PropertyGridTableFooterMemo);
