    ...
    Tables: {
      activities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "activities_client_user_id_fkey"
      ...
      companies: {
        ...
        Relationships: [
          {
            foreignKeyName: "companies_created_by_company_id_fkey"
      ...
      meetings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "meetings_client_user_id_fkey"
            columns: ["client_user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      quotations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "quotations_client_user_id_fkey"
            columns: ["client_user_id"]
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
