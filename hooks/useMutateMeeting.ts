  ...
  const createMeetingMutation = useMutation(
    async (newMeeting: Omit<Meeting, "id" | "created_at" | "updated_at">) => {
      ...
      const newMeetingAndActivityPayload = {
        ...
        _created_by_section_of_user: newMeeting.created_by_section_of_user,
        ...
        // 年度〜四半期
        _activity_quarter: newMeeting.meeting_quarter,
        _activity_half_year: newMeeting.meeting_half_year,
        _activity_fiscal_year: newMeeting.meeting_fiscal_year,
        // _meeting_id: ,
        _property_id: null,
        _quotation_id: null,
      };
  ...
  const updateMeetingMutation = useMutation(
    ...
    async (newMeeting: Omit<ResultMeetingWithProductsAttendees, "created_at" | "updated_at">) => {
      ...
      const updateMeetingPayload = {
        ...
        _member_name: newMeeting.meeting_member_name,
        // priority: null,
        _activity_date: newMeeting.result_date ? newMeeting.result_date : newMeeting.planned_date,
        _activity_year_month: newMeeting.meeting_year_month,
        // 年度〜四半期
        _activity_quarter: newMeeting.meeting_quarter,
        _activity_half_year: newMeeting.meeting_half_year,
