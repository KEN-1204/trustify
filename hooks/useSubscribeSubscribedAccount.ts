...
export const useSubscribeSubscribedAccount = () => {
  ...
  useEffect(() => {
    if (!userProfileState)
      return console.log("リアルタイムsubscribed_accounts ユーザー情報無し userProfile", userProfileState);
    ...
    const channel = supabase
      ...
      .on(
        ...
        async (payload: any) => {
          ...
          console.log("リアルタイムsubscribed_accounts UPDATE検知 🔥", payload, userProfileState);
